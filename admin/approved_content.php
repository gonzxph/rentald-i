                        ...
                        <table class="table table-bordered" id="approvedTable">
                            ...
                            <tbody>
                               ...
                               r.rent_dropoff_location
                                ...
                                WHERE p.pay_type = 'fullPayment' OR r.rent_status = 'APPROVED'
                                ...
                                if ($result && $result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>
                                          <a href='approved_rent_details.php?rental_id={$row['rental_id']}' title='View'>
                                                <i class='fas fa-plus view-icon' style='background-color: red; color: white; padding: 5px; border-radius: 50%;'></i>
                                            </a>
